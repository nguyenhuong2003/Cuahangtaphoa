...
namespace GUI
{
    public partial class GUI_NhanVien : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Cảnh báo: Tên nhà nhân viên không được trống!", "Thông báo",
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txtTenNV.Text))
            {
                MessageBox.Show("Cảnh báo: Tên nhà cung cấp không không được trống và nhập kí tự số!", "Thông báo",
                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            if (string.IsNullOrEmpty(txtDiaChi.Text))
        ...
        private void grpNhapTTNV_Enter(object sender, EventArgs e)
        {
